...
export const profileActivityData2 = [
    {
        ...
        description: 'Alphonic Crm is a clean bootstrap admin dashboard, frontend and webapps template pack that built with most popular bootstrap framework and modern technology\'s.',
        badges: [
    ...
    {
        color: 'danger',
        title: 'Event start soon #Alphonic Crm',
        description: 'Alphonic Crm is a clean bootstrap admin dashboard, frontend and webapps template pack that built with most popular bootstrap framework and modern technology\'s.',
        badges: [
            {
                users: [
