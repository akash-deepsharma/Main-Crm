...
import { ClientTableData } from '@/utils/fackData/ClientTableData';
...
const ProjectTable = () => {
        ...
        },
        {
            ...
            cell: info => (
                <div className="hstack gap-2 justify-content-end">
                    <a href="/clients/view" className="avatar-text avatar-md">
                        <FiEye />
                    </a>
    ...
    return (
        <>
            <Table data={ClientTableData} columns={columns} />
        </>
    )
}
