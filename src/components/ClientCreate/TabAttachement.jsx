...
const router = useRouter()
  ...
  try {
    ...
    selectedDocs.forEach((doc, index) => {
      ...
      formData.append(`documents[${index}][file_type]`, doc.file.type); 
    //   agar icon alag file ho to doc.iconFile bhejo
    });

    const response = await fetch(
      `${API_BASE}/client/document/upload`,
      {
        method: "POST",
        headers: {
    ...
    console.log("Attachment API response:", result);
