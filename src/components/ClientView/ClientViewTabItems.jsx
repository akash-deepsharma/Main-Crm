            ...
            <div className="d-flex align-items-center justify-content-between">
                <div className="nav-tabs-wrapper page-content-left-sidebar-wrapper">
                    ...
                    <ul className="nav nav-tabs nav-tabs-custom-style" id="myTab" role="tablist">
                        ...
                        <li className="nav-item" role="presentation">
                            <button className="nav-link" data-bs-toggle="tab" data-bs-target="#timesheetsTab">Service Details</button>
                        </li>
                        <li className="nav-item" role="presentation">
                            <button className="nav-link" data-bs-toggle="tab" data-bs-target="#milestonesTab">Wages Sheet</button>
                        </li>
                        <li className="nav-item" role="presentation">
